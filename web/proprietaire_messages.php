...
<head>
    ...
    <title>Mes Messages | Propriétaire</title>
    ...
    <style>
        ...
        .conv-card.unread { background: var(--unread-bg); }
        ...
        .contact-name { font-weight: 700; font-size: 15px; color: var(--text-main); }
    ...
    <?php if(count($conversations) > 0): ?>
        ...
        <a href="message.php?id_receiver=<?php echo $c['contact_id']; ?>&id_annonce=<?php echo $c['id_annonce']; ?>" 
           class="conv-card <?php echo $is_unread ? 'unread' : ''; ?>">
            ...
            <img src="uploads/<?php echo $c['annonce_image']; ?>" class="annonce-preview">
        </a>
        <?php endforeach; ?>
    <?php else: ?>
        <div class="empty-chats">
            <i class="fas fa-comments" style="font-size: 50px; opacity: 0.1; margin-bottom: 15px;"></i>
            <h3>Pas encore de messages</h3>
            <p>Dès qu'un étudiant vous contactera, ses messages apparaîtront ici.</p>
        </div>
    <?php endif; ?>
</div>
...
<nav class="bottom-nav">
    ...
    <a href="proprietaire_messages.php" class="nav-item active">
